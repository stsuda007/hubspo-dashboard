...
min_date_val = merged_df[date_col].min().date() if not merged_df[date_col].isna().all() else datetime.now().date()
max_date_val = merged_df[date_col].max().date() if not merged_df[date_col].isna().all() else datetime.now().date()
